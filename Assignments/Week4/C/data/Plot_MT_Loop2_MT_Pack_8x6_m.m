%% Impact of parallelizing packing on a multithreaded implementation of the second loop around the micro-kernel
...
% Plot results for multithreaded Loop 2, without multithreading packing
...
% Optionally, plot results for multithreaded Loop 2, with multithreading of
% the packing of blocks of A
if ( 1 ) 
    output_MT_Loop2_MT_PackA_8x6Kernel
    
    plot( data(:,1), data(:,5)/omp_num_threads , 'DisplayName', 'MT Loop 2 MT Pack A', 'MarkerSize', 8, 'LineWidth', 2, ...
...
if ( 0 ) 
    output_MT_Loop2_MT_PackB_8x6Kernel
    
    plot( data(:,1), data(:,5)/omp_num_threads , 'DisplayName', 'MT Loop 2 MT Pack B', 'MarkerSize', 8, 'LineWidth', 2, ...
          'Marker', 'o', 'LineStyle', '-.', 'Color', plot_colors( 5,: ) );
end

% Optionally, plot results for multithreaded Loop 2, with multithreading of
% the packing of blocks of A and row panels of B
if ( 0 ) 
    output_MT_Loop2_MT_PackAB_8x6Kernel
    
    plot( data(:,1), data(:,5)/omp_num_threads , 'DisplayName', 'MT Loop 2 MT Pack A and B', 'MarkerSize', 8, 'LineWidth', 2, ...
...
print( 'Plot_MT_Loop2_MT_Pack.png', '-dpng' );